...
<table>
  <tr>
    <td align="center">
      <strong>Workout plan</strong><br><br>
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="screenshots/workouts-dark.png">
        <img alt="IronSet workout plan" src="screenshots/workouts-light.png" width="320">
      </picture>
    </td>
    <td align="center">
      <strong>Set-by-set training</strong><br><br>
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="screenshots/active-workout-dark.png">
        <img alt="Active workout in IronSet" src="screenshots/active-workout-light.png" width="320">
      </picture>
    </td>
  </tr>
  <tr>
    <td align="center">
      <strong>Your equipment</strong><br><br>
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="screenshots/equipment-dark.png">
        <img alt="Equipment in IronSet" src="screenshots/equipment-light.png" width="320">
      </picture>
    </td>
    <td align="center">
      <strong>History and statistics</strong><br><br>
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="screenshots/statistics-dark.png">
        <img alt="Training statistics in IronSet" src="screenshots/statistics-light.png" width="320">
      </picture>
    </td>
  </tr>
  <tr>
    <td align="center" colspan="2">
      <strong>Settings and backups</strong><br><br>
      <picture>
        <source media="(prefers-color-scheme: dark)" srcset="screenshots/settings-dark.png">
        <img alt="IronSet settings" src="screenshots/settings-light.png" width="320">
      </picture>
    </td>
  </tr>
</table>
